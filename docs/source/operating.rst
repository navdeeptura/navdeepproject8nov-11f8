[navdeepproject8nov-11f8] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [navdeepproject8nov-11f8] container is NOT running**.

.. tip::
   You must have your [navdeepproject8nov-11f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34015  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='navdeeptura'  \-\-env DOCKERUSERNAME='navdeeptura'  \-\-env MQTTUSERNAME='turanavdeep'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   navdeeptura/navdeepproject8nov-11f8-amd64 (https://hub.docker.com/r/navdeeptura/navdeepproject8nov-11f8-amd64)
...
.. important::
   docker run -d -p 53255:53255 -p 41949:41949 -p 54317:54317 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=navdeepproject8nov-11f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-navdeepproject8nov-11f8 \-\-env GITUSERNAME=navdeeptura  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi \-\-env SOLUTIONEXTERNALPORT=53255  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41949  \-\-env SOLUTIONVIPERVIZPORT=54317 \-\-env DOCKERUSERNAME='navdeeptura' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=34015 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='turanavdeep' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  navdeeptura/navdeepproject8nov-11f8-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - navdeeptura/navdeepproject8nov-11f8-amd64
...
[navdeepproject8nov-11f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/navdeeptura/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/navdeepproject8nov-11f8
...
.. important::
   https://navdeepproject8nov-11f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-navdeepproject8nov-11f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=53255, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46337, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=44365, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40747, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38221, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37253, HPDEHOST=127.0.1.1, HPDEPORT=45709, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45687

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5447-navdeepproject8nov-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject8nov-11f8, python-preprocess-5179-navdeepproject8nov-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject8nov-11f8, python-ai-4855-navdeepproject8nov-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject8nov-11f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
